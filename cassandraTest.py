# -*- coding: utf-8 -*-
'''
This script is the a simple functionality test for querying a local cassandra DB using the DataStax Python Driver for Apache Cassandra. The driver is a modern, feature-rich and highly-tunable Python client library for Apache Cassandra (1.2+) and DataStax Enterprise (3.1+) using exclusively Cassandra's binary protocol and Cassandra Query Language v3.
